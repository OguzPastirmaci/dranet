...
func TestParseCloudProviderOptions(t *testing.T) {
	tests := []struct {
		...
		{name: "cks namespace parses", value: "cks.something=x", want: map[string]string{"cks.something": "x"}},
		{name: "every provider namespace parses", value: "gce.a=1,aws.a=1,azure.a=1,oke.a=1,alibaba.a=1,cks.a=1,webhook.a=1",
			want: map[string]string{"gce.a": "1", "aws.a": "1", "azure.a": "1", "oke.a": "1", "alibaba.a": "1", "cks.a": "1", "webhook.a": "1"}},
		...
		{name: "uppercase namespace", value: "OKE.a=1", wantErr: true},
		{name: "none namespace", value: "none.a=1", wantErr: true},
	}
...
// A wrong pairing would send an option to the wrong provider hint.
func TestOptionNamespacesMatchHints(t *testing.T) {
	for namespace, hint := range optionNamespaces {
		if namespace != strings.ToLower(string(hint)) {
			t.Errorf("optionNamespaces[%q] = %q, want the hint whose lowercase form is %q", namespace, hint, namespace)
		}
	}
}
